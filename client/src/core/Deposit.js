...
import { deposit } from "./helper/coreapicalls";

const Deposit = ({ setReload = (f) => f, reload = undefined }) => {
  ...
  return (
    <Base>
      <div className="w-50 p-5 center">
        <div class="jumbotron">
          <h4 className="text-center m-3">Enter Amount to Deposit</h4>
          <input
            type="Number"
